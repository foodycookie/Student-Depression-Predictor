...
# Frequency encoding for City and Degree
city_freq_map = df['City'].value_counts(normalize=True).to_dict()
degree_freq_map = df['Degree'].value_counts(normalize=True).to_dict()
